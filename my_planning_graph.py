...
class ActionLayer(BaseActionLayer):
    ...
    def _inconsistent_effects(self, actionA, actionB):
        ...
        return any([~ect in actionA.effects for ect in actionB.effects] + [~ect in actionB.effects for ect in actionA.effects])
    ...
    def _interference(self, actionA, actionB):
        ...
        """
        # TODO: implement this function
        return any([~ect in actionA.preconditions for ect in actionB.effects]) \
                or any([~ect in actionB.preconditions for ect in actionA.effects])
